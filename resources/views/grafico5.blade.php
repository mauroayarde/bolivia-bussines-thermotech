    ...
    <div class="row justify-content-center">
        <div class="col-md">
            ...
            <div class="card" style="margin-top: 30px;">
                <div class="card-body" style="font-size: 18px; color: #000; background-color: rgba(240,240,240); text-align: center;position: relative;width: 60vw;">
                    Consulta 5
                    @if (session('success'))
...
const myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: 'KPI ventas 2019',
            data: [2.66,2.8,3.97,3.95,3.40,2.42,3.5,2.37,2.15,2.79,2.86,1.875],
            backgroundColor: [
                'rgba(255, 99, 132, 33)',
                'rgba(54, 162, 235, 33)',
                'rgba(255, 206, 86, 33)',
