...
<main class="login-form">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md">
                <div class="card">
                    <div class="card-header" style="background-color: #007BFF; color: #FFFFFF; font-size: 24px; font-weight: bold; text-align: center;">THERMOTECH</div>
                    <div class="card-body" style="background-color: #FFFFFF;">
                        <form action="{{ route('register.post') }}" method="POST">
                            @csrf
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right" style="font-weight: bold;">Nombre</label>
                                <div class="col-md-6">
                            ...
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" style="font-weight: bold; background-color: #007BFF; color: #FFFFFF;">Registrar</button>
                            </div>
                        </form>
                    </div>
                </div>
